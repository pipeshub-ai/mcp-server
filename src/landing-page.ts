      ...
      <div class="content-container">
            ...
            <div class="header-actions">
              ...
              <div class="popover">
                ...
                <div class="popover-menu hidden" id="popover-menu">
                  <a class="popover-button install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=SDK&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJtY3AiLCJzdGFydCIsIi0tc2VydmVyLXVybCIsIiIsIi0tYmVhcmVyLWF1dGgiLCIiXX0=">
                    Cursor
                  </a>
                  ...
                  <a class="popover-button install-link" href="vscode://ms-vscode.vscode-mcp/install?name=SDK&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJtY3AiLCJzdGFydCIsIi0tc2VydmVyLXVybCIsIiIsIi0tYmVhcmVyLWF1dGgiLCIiXX0=">
                    VS Code
                  </a>
        ...
        <section class="install container">
          ...
          <div class="install-targets">
            <a tabindex="0" class="card install-target install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=SDK&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJtY3AiLCJzdGFydCIsIi0tc2VydmVyLXVybCIsIiIsIi0tYmVhcmVyLWF1dGgiLCIiXX0=">
              <div class="target">
            ...
            <a tabindex="0" class="card install-target install-link" href="vscode://ms-vscode.vscode-mcp/install?name=SDK&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJtY3AiLCJzdGFydCIsIi0tc2VydmVyLXVybCIsIiIsIi0tYmVhcmVyLWF1dGgiLCIiXX0=">
              <div class="target">
    ...
    <div class="modal" id="claude-code-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="claude-cli-cmd">claude mcp add SDK -- npx -y mcp start --server-url  --bearer-auth </code>
        </div>
      </div>
    </div>
    ...
    <div class="modal" id="gemini-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="gemini-config">gemini mcp add SDK -- npx -y mcp start --server-url  --bearer-auth </code>
        </div>
      </div>
    </div>
