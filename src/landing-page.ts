      ...
      <div class="content-container">
            ...
            <div class="header-actions">
              ...
              <div class="popover">
                ...
                <div class="popover-menu hidden" id="popover-menu">
                  <a class="popover-button install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=SDK&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJtY3AiLCJzdGFydCIsIi0tc2VydmVyLXVybCIsImh0dHA6Ly9sb2NhbGhvc3Q6MzAwMCIsIi0tYmVhcmVyLWF1dGgiLCIiLCItLWNsaWVudC1pZCIsIiIsIi0tY2xpZW50LXNlY3JldCIsIiIsIi0tdG9rZW4tdXJsIiwiL2FwaS92MS9vYXV0aC90b2tlbiJdfQ==">
                    Cursor
                  </a>
        ...
        <section class="install container">
          ...
          <div class="install-targets">
            <a tabindex="0" class="card install-target install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=SDK&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJtY3AiLCJzdGFydCIsIi0tc2VydmVyLXVybCIsImh0dHA6Ly9sb2NhbGhvc3Q6MzAwMCIsIi0tYmVhcmVyLWF1dGgiLCIiLCItLWNsaWVudC1pZCIsIiIsIi0tY2xpZW50LXNlY3JldCIsIiIsIi0tdG9rZW4tdXJsIiwiL2FwaS92MS9vYXV0aC90b2tlbiJdfQ==">
              <div class="target">
    ...
    <div class="modal" id="claude-code-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="claude-cli-cmd">claude mcp add SDK -- npx -y mcp start --server-url http://localhost:3000 --bearer-auth  --client-id  --client-secret  --token-url /api/v1/oauth/token</code>
        </div>
      </div>
    </div>
    ...
    <div class="modal" id="gemini-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="gemini-config">gemini mcp add SDK -- npx -y mcp start --server-url http://localhost:3000 --bearer-auth  --client-id  --client-secret  --token-url /api/v1/oauth/token</code>
        </div>
      </div>
    </div>
