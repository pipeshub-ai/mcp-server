...
export const TemplateData$zodSchema: z.ZodType<TemplateData> = z.union([
  AppUserInviteTemplateData$zodSchema,
  LoginWithOTPTemplateData$zodSchema,
  ResetPasswordTemplateData$zodSchema,
  AccountCreationTemplateData$zodSchema,
...
export const MailBody$zodSchema: z.ZodType<MailBody> = z.object({
