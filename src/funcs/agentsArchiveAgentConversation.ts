...
import {
  ...
  ArchiveAgentConversationRequest$zodSchema,
} from "../models/archiveagentconversationop.js";
 ...
 */
export function agentsArchiveAgentConversation(
  client$: SDKCore,
  request: ArchiveAgentConversationRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ArchiveAgentConversationRequest$zodSchema.parse(value$),
