...
import {
  ...
  ListAgentConversationsRequest$zodSchema,
} from "../models/listagentconversationsop.js";
 ...
 */
export function agentConversationsListAgentConversations(
  client$: SDKCore,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ListAgentConversationsRequest$zodSchema.parse(value$),
