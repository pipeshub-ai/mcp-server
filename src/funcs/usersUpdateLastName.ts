...
import {
  ...
  UpdateUserLastNameRequest$zodSchema,
} from "../models/updateuserlastnameop.js";
 ...
 */
export function usersUpdateLastName(
  client$: PipeshubCore,
  request: UpdateUserLastNameRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UpdateUserLastNameRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/users/{id}/lastName")(
    pathParams$,
  );
