...
import {
  ...
  GetKnowledgeBaseRequest$zodSchema,
} from "../models/getknowledgebaseop.js";
 ...
 */
export function knowledgeBasesGetKnowledgeBase(
  client$: PipeshubCore,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetKnowledgeBaseRequest$zodSchema.parse(value$),
