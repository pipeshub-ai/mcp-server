...
import {
  ...
  ToggleMetricsCollectionRequest$zodSchema,
} from "../models/togglemetricscollectionop.js";
 ...
 */
export function metricsCollectionToggleMetricsCollection(
  client$: SDKCore,
  request: ToggleMetricsCollectionRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ToggleMetricsCollectionRequest$zodSchema.parse(value$),
