...
import {
  ...
  GetConnectorFiltersRequest$zodSchema,
} from "../models/getconnectorfiltersop.js";
 ...
 */
export function connectorFiltersGetConnectorFilters(
  client$: SDKCore,
  request: GetConnectorFiltersRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetConnectorFiltersRequest$zodSchema.parse(value$),
