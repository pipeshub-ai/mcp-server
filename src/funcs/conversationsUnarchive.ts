...
import {
  ...
  UnarchiveConversationRequest$zodSchema,
} from "../models/unarchiveconversationop.js";
 ...
 */
export function conversationsUnarchive(
  client$: PipeshubCore,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UnarchiveConversationRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/conversations/{conversationId}/unarchive")(
    pathParams$,
  );
