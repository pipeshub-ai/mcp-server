...
import {
  ...
  GetAgentConversationRequest$zodSchema,
} from "../models/getagentconversationop.js";
 ...
 */
export function agentConversationsGetAgentConversation(
  client$: SDKCore,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetAgentConversationRequest$zodSchema.parse(value$),
