...
import {
  ...
  GetAgentConversationByIdRequest$zodSchema,
} from "../models/getagentconversationbyidop.js";
...
export function agentsGetAgentConversationById(
  client$: SDKCore,
  request: GetAgentConversationByIdRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetAgentConversationByIdRequest$zodSchema.parse(value$),
