...
import {
  ...
  UpdateConnectorConfigRequestRequest$zodSchema,
} from "../models/updateconnectorconfigop.js";
 ...
 * are not modified.
 */
export function connectorConfigurationUpdateConnectorConfig(
  client$: PipeshubCore,
  request: UpdateConnectorConfigRequestRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UpdateConnectorConfigRequestRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/connectors/{connectorId}/config")(
    pathParams$,
  );
