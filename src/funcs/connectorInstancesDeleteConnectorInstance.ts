...
import {
  ...
  DeleteConnectorInstanceRequest$zodSchema,
} from "../models/deleteconnectorinstanceop.js";
 ...
 * </ul>
 */
export function connectorInstancesDeleteConnectorInstance(
  client$: SDKCore,
  request: DeleteConnectorInstanceRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => DeleteConnectorInstanceRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/connectors/{connectorId}")(
    pathParams$,
  );
