...
import {
  ...
  GetFolderChildrenRequest$zodSchema,
} from "../models/getfolderchildrenop.js";
 ...
 */
export function foldersGetFolderChildren(
  client$: SDKCore,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetFolderChildrenRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/knowledgeBase/{kbId}/folder/{folderId}/children")(
    pathParams$,
  );
