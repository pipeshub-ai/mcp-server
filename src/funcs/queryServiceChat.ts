...
import {
  QueryServiceChatOpServerList,
  QueryServiceChatRequest,
  QueryServiceChatRequest$zodSchema,
} from "../models/queryservicechatop.js";
...
export function queryServiceChat(
  client$: PipeshubCore,
  request: QueryServiceChatRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => QueryServiceChatRequest$zodSchema.parse(value$),
