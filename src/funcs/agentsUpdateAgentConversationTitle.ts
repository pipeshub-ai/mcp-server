...
import {
  ...
  UpdateAgentConversationTitleRequest$zodSchema,
} from "../models/updateagentconversationtitleop.js";
 ...
 * non-empty.
 */
export function agentsUpdateAgentConversationTitle(
  client$: SDKCore,
  request: UpdateAgentConversationTitleRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UpdateAgentConversationTitleRequest$zodSchema.parse(value$),
