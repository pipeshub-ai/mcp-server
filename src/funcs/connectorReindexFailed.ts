...
import {
  ...
  ReindexFailedConnectorRecordsRequest$zodSchema,
} from "../models/reindexfailedconnectorrecordsop.js";
 ...
 */
export function connectorReindexFailed(
  client$: PipeshubCore,
  request: ReindexFailedConnectorRecordsRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ReindexFailedConnectorRecordsRequest$zodSchema.parse(value$),
