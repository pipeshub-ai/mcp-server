...
import {
  AIModelsConfigInput,
  AIModelsConfigInput$zodSchema,
} from "../models/aimodelsconfiginput.js";
 ...
 */
export function aiModelsConfigurationCreate(
  client$: PipeshubCore,
  request: AIModelsConfigInput,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => AIModelsConfigInput$zodSchema.parse(value$),
