...
import {
  ...
  AddAgentMessageRequest$zodSchema,
} from "../models/addagentmessageop.js";
 ...
 */
export function agentConversationsAddAgentMessage(
  client$: SDKCore,
  request: AddAgentMessageRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => AddAgentMessageRequest$zodSchema.parse(value$),
