...
import {
  ...
  UpdateAgentConversationMessageFeedbackRequest$zodSchema,
} from "../models/updateagentconversationmessagefeedbackop.js";
 ...
 */
export function agentsUpdateAgentConversationMessageFeedback(
  client$: SDKCore,
  request: UpdateAgentConversationMessageFeedbackRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      UpdateAgentConversationMessageFeedbackRequest$zodSchema.parse(value$),
