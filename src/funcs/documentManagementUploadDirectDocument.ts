...
import {
  ...
  UploadDirectDocumentRequest$zodSchema,
} from "../models/uploaddirectdocumentop.js";
...
export function documentManagementUploadDirectDocument(
  client$: SDKCore,
  request: UploadDirectDocumentRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UploadDirectDocumentRequest$zodSchema.parse(value$),
