...
import {
  GetTeamUsersRequest,
  GetTeamUsersRequest$zodSchema,
} from "../models/getteamusersop.js";
 ...
 * </ul>
 */
export function teamsGetUsers(
  client$: PipeshubCore,
  request: GetTeamUsersRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetTeamUsersRequest$zodSchema.parse(value$),
