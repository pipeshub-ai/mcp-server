...
import {
  ...
  DeleteAgentConversationByIdRequest$zodSchema,
} from "../models/deleteagentconversationbyidop.js";
 ...
 */
export function agentsDeleteAgentConversationById(
  client$: SDKCore,
  request: DeleteAgentConversationByIdRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => DeleteAgentConversationByIdRequest$zodSchema.parse(value$),
