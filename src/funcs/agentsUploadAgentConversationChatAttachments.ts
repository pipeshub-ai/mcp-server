...
import {
  ...
  UploadAgentConversationChatAttachmentsRequest$zodSchema,
} from "../models/uploadagentconversationchatattachmentsop.js";
...
export function agentsUploadAgentConversationChatAttachments(
  client$: SDKCore,
  request: UploadAgentConversationChatAttachmentsRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      UploadAgentConversationChatAttachmentsRequest$zodSchema.parse(value$),
  ...
  if (payload$.body.conversationId !== undefined) {
    appendForm(body$, "conversationId", payload$.body.conversationId);
  }
