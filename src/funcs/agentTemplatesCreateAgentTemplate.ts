...
import {
  ...
  CreateAgentTemplateRequest$zodSchema,
} from "../models/createagenttemplateop.js";
 ...
 * </ul>
 */
export function agentTemplatesCreateAgentTemplate(
  client$: SDKCore,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CreateAgentTemplateRequest$zodSchema.parse(value$),
