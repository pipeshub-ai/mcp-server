...
import {
  ...
  GoogleWorkspaceOAuthConfig$zodSchema,
} from "../models/googleworkspaceoauthconfig.js";
 ...
 */
export function connectorOAuthConfigurationSetGoogleWorkspaceConfig(
  client$: PipeshubCore,
  request: GoogleWorkspaceOAuthConfig,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GoogleWorkspaceOAuthConfig$zodSchema.parse(value$),
