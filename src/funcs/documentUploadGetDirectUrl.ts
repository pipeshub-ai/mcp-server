...
import {
  ...
  GetDirectUploadUrlRequest$zodSchema,
} from "../models/getdirectuploadurlop.js";
 ...
 */
export function documentUploadGetDirectUrl(
  client$: PipeshubCore,
  request: GetDirectUploadUrlRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetDirectUploadUrlRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/document/{documentId}/directUpload")(
    pathParams$,
  );
