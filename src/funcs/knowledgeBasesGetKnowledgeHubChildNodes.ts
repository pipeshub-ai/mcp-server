...
import {
  ...
  GetKnowledgeHubChildNodesRequest$zodSchema,
} from "../models/getknowledgehubchildnodesop.js";
 ...
 */
export function knowledgeBasesGetKnowledgeHubChildNodes(
  client$: PipeshubCore,
  request: GetKnowledgeHubChildNodesRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetKnowledgeHubChildNodesRequest$zodSchema.parse(value$),
