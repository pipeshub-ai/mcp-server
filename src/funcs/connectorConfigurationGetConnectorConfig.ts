...
import {
  ...
  GetConnectorConfigRequest$zodSchema,
} from "../models/getconnectorconfigop.js";
 ...
 */
export function connectorConfigurationGetConnectorConfig(
  client$: PipeshubCore,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetConnectorConfigRequest$zodSchema.parse(value$),
