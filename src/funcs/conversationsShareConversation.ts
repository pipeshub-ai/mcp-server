...
import {
  ...
  ShareConversationRequest$zodSchema,
} from "../models/shareconversationop.js";
 ...
 */
export function conversationsShareConversation(
  client$: SDKCore,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ShareConversationRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/conversations/{conversationId}/share")(
    pathParams$,
  );
