...
import {
  ...
  GetAllUsersWithGroupsRequest$zodSchema,
} from "../models/getalluserswithgroupsop.js";
 ...
 */
export function usersGetWithGroups(
  client$: PipeshubCore,
  request?: GetAllUsersWithGroupsRequest | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetAllUsersWithGroupsRequest$zodSchema.optional().parse(value$),
