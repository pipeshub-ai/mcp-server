...
import {
  ...
  ListConfiguredConnectorsRequest$zodSchema,
} from "../models/listconfiguredconnectorsop.js";
 ...
 */
export function connectorInstancesListConfiguredConnectors(
  client$: PipeshubCore,
  request?: ListConfiguredConnectorsRequest | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      ListConfiguredConnectorsRequest$zodSchema.optional().parse(value$),
