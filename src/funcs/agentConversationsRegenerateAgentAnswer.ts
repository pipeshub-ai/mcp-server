...
import {
  ...
  RegenerateAgentAnswerRequest$zodSchema,
} from "../models/regenerateagentanswerop.js";
 ...
 */
export function agentConversationsRegenerateAgentAnswer(
  client$: SDKCore,
  request: RegenerateAgentAnswerRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => RegenerateAgentAnswerRequest$zodSchema.parse(value$),
