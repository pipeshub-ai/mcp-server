...
import {
  ...
  AddUsersToGroupRequest$zodSchema,
} from "../models/adduserstogroupop.js";
 ...
 * </ul>
 */
export function userGroupsAddUsersToGroup(
  client$: SDKCore,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => AddUsersToGroupRequest$zodSchema.parse(value$),
