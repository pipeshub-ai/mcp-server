...
import {
  ...
  UnarchiveAgentConversationRequest$zodSchema,
} from "../models/unarchiveagentconversationop.js";
 ...
 */
export function agentsUnarchiveAgentConversation(
  client$: SDKCore,
  request: UnarchiveAgentConversationRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UnarchiveAgentConversationRequest$zodSchema.parse(value$),
