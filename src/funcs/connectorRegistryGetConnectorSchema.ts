...
import {
  ...
  GetConnectorSchemaRequest$zodSchema,
} from "../models/getconnectorschemaop.js";
 ...
 * </ul>
 */
export function connectorRegistryGetConnectorSchema(
  client$: SDKCore,
  request: GetConnectorSchemaRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetConnectorSchemaRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/connectors/registry/{connectorType}/schema")(
    pathParams$,
  );
