...
import {
  SamlCallbackRequest,
  SamlCallbackRequest$zodSchema,
} from "../models/samlcallbackop.js";
...
export function samlCallback(
  client$: PipeshubCore,
  request?: SamlCallbackRequest | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => SamlCallbackRequest$zodSchema.optional().parse(value$),
