...
import {
  ...
  CreateKBPermissionRequest$zodSchema,
} from "../models/createkbpermissionop.js";
 ...
 */
export function permissionsCreateKBPermission(
  client$: SDKCore,
  request: CreateKBPermissionRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CreateKBPermissionRequest$zodSchema.parse(value$),
