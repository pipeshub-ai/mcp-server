...
import {
  ...
  UploadRecordsToKBRequest$zodSchema,
} from "../models/uploadrecordstokbop.js";
...
export function uploadUploadRecordsToKB(
  client$: SDKCore,
  request: UploadRecordsToKBRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UploadRecordsToKBRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/knowledgeBase/{kbId}/upload")(
    pathParams$,
  );
