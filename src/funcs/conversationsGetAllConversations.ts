...
import {
  ...
  GetAllConversationsRequest$zodSchema,
} from "../models/getallconversationsop.js";
...
export function conversationsGetAllConversations(
  client$: SDKCore,
  request?: GetAllConversationsRequest | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetAllConversationsRequest$zodSchema.optional().parse(value$),
