...
import {
  ...
  DeleteAgentConversationChatAttachmentRequest$zodSchema,
} from "../models/deleteagentconversationchatattachmentop.js";
 ...
 */
export function agentsDeleteAgentConversationChatAttachment(
  client$: SDKCore,
  request: DeleteAgentConversationChatAttachmentRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      DeleteAgentConversationChatAttachmentRequest$zodSchema.parse(value$),
