...
import {
  ...
  GetUserGroupByIdRequest$zodSchema,
} from "../models/getusergroupbyidop.js";
 ...
 * </ul>
 */
export function userGroupsGetUserGroupById(
  client$: SDKCore,
  request: GetUserGroupByIdRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetUserGroupByIdRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/userGroups/{groupId}")(
    pathParams$,
  );
