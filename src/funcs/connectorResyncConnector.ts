...
import {
  ...
  ResyncConnectorRequest$zodSchema,
} from "../models/resyncconnectorop.js";
 ...
 */
export function connectorResyncConnector(
  client$: SDKCore,
  request: ResyncConnectorRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ResyncConnectorRequest$zodSchema.parse(value$),
