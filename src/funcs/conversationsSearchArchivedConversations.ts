...
import {
  ...
  SearchArchivedConversationsRequest$zodSchema,
} from "../models/searcharchivedconversationsop.js";
...
export function conversationsSearchArchivedConversations(
  client$: SDKCore,
  request: SearchArchivedConversationsRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => SearchArchivedConversationsRequest$zodSchema.parse(value$),
