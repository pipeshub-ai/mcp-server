...
import {
  ...
  SetMetricsServerUrlRequest$zodSchema,
} from "../models/setmetricsserverurlop.js";
 ...
 */
export function metricsCollectionConfigureServerUrl(
  client$: PipeshubCore,
  request: SetMetricsServerUrlRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => SetMetricsServerUrlRequest$zodSchema.parse(value$),
