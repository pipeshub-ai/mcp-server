...
import {
  ...
  DeleteSearchHistoryRequest$zodSchema,
} from "../models/deletesearchhistoryop.js";
...
export function semanticSearchDeleteSearchHistory(
  client$: SDKCore,
  request?: DeleteSearchHistoryRequest | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => DeleteSearchHistoryRequest$zodSchema.optional().parse(value$),
