...
import {
  ...
  GetArchivedConversationsRequest$zodSchema,
} from "../models/getarchivedconversationsop.js";
 ...
 * to the active list.
 */
export function conversationsGetArchivedConversations(
  client$: SDKCore,
  request?: GetArchivedConversationsRequest | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      GetArchivedConversationsRequest$zodSchema.optional().parse(value$),
