...
import {
  OAuthConsentRequest,
  OAuthConsentRequest$zodSchema,
} from "../models/oauthconsentrequest.js";
 ...
 */
export function oAuthProviderOauthAuthorizeConsent(
  client$: PipeshubCore,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => OAuthConsentRequest$zodSchema.parse(value$),
