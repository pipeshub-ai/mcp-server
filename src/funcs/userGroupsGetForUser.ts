...
import {
  ...
  GetGroupsForUserRequest$zodSchema,
} from "../models/getgroupsforuserop.js";
 ...
 * </ul>
 */
export function userGroupsGetForUser(
  client$: PipeshubCore,
  request: GetGroupsForUserRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetGroupsForUserRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/user-groups/users/{userId}")(
    pathParams$,
  );
