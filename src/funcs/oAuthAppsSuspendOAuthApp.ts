...
import {
  ...
  SuspendOAuthAppRequest$zodSchema,
} from "../models/suspendoauthappop.js";
 ...
 */
export function oAuthAppsSuspendOAuthApp(
  client$: PipeshubCore,
  request: SuspendOAuthAppRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => SuspendOAuthAppRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/oauth-clients/{appId}/suspend")(
    pathParams$,
  );
