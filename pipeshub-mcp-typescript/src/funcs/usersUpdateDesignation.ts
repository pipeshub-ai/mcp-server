...
import {
  ...
  UpdateUserDesignationRequest$zodSchema,
} from "../models/updateuserdesignationop.js";
...
export function usersUpdateDesignation(
  client$: PipeshubCore,
  request: UpdateUserDesignationRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UpdateUserDesignationRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/users/{id}/designation")(
    pathParams$,
  );
