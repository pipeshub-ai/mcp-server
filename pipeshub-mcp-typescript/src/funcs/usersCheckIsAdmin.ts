...
import {
  ...
  CheckUserIsAdminRequest$zodSchema,
} from "../models/checkuserisadminop.js";
 ...
 * </ul>
 */
export function usersCheckIsAdmin(
  client$: PipeshubCore,
  request: CheckUserIsAdminRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CheckUserIsAdminRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/users/{id}/adminCheck")(
    pathParams$,
  );
