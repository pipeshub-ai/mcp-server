...
import {
  ...
  SetMetricsPushIntervalRequest$zodSchema,
} from "../models/setmetricspushintervalop.js";
 ...
 */
export function metricsCollectionSetPushInterval(
  client$: PipeshubCore,
  request: SetMetricsPushIntervalRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => SetMetricsPushIntervalRequest$zodSchema.parse(value$),
