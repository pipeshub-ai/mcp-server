...
import {
  QueryServiceSearchOpServerList,
  QueryServiceSearchRequest,
  QueryServiceSearchRequest$zodSchema,
} from "../models/queryservicesearchop.js";
 ...
 * </ol>
 */
export function queryServiceSearch(
  client$: PipeshubCore,
  request: QueryServiceSearchRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => QueryServiceSearchRequest$zodSchema.parse(value$),
