...
import {
  ...
  RemoveUsersFromTeamRequest$zodSchema,
} from "../models/removeusersfromteamop.js";
 ...
 * </ul>
 */
export function teamsRemoveUsers(
  client$: PipeshubCore,
  request: RemoveUsersFromTeamRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => RemoveUsersFromTeamRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/teams/{teamId}/users")(
    pathParams$,
  );
