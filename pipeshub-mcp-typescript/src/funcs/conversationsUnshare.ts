...
import {
  ...
  UnshareConversationRequest$zodSchema,
} from "../models/unshareconversationop.js";
 ...
 */
export function conversationsUnshare(
  client$: PipeshubCore,
  request: UnshareConversationRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UnshareConversationRequest$zodSchema.parse(value$),
