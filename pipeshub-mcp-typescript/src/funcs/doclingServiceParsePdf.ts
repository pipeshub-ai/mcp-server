...
import {
  DoclingParsePdfOpServerList,
  DoclingParsePdfRequest,
  DoclingParsePdfRequest$zodSchema,
} from "../models/doclingparsepdfop.js";
...
export function doclingServiceParsePdf(
  client$: PipeshubCore,
  request: DoclingParsePdfRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => DoclingParsePdfRequest$zodSchema.parse(value$),
