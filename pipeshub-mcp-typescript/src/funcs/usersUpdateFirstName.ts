...
import {
  ...
  UpdateUserFirstNameRequest$zodSchema,
} from "../models/updateuserfirstnameop.js";
...
export function usersUpdateFirstName(
  client$: PipeshubCore,
  request: UpdateUserFirstNameRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UpdateUserFirstNameRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/users/{id}/firstName")(
    pathParams$,
  );
