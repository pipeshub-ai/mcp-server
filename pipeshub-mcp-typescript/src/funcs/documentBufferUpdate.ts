...
import {
  ...
  UpdateDocumentBufferRequest$zodSchema,
} from "../models/updatedocumentbufferop.js";
...
export function documentBufferUpdate(
  client$: PipeshubCore,
  request: UpdateDocumentBufferRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UpdateDocumentBufferRequest$zodSchema.parse(value$),
