...
import {
  ...
  ReindexRecordRequest$zodSchema,
} from "../models/reindexrecordop.js";
 ...
 */
export function connectorsReindexRecord(
  client$: PipeshubCore,
  request: ReindexRecordRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ReindexRecordRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/knowledgeBase/reindex/record/{recordId}")(
    pathParams$,
  );
