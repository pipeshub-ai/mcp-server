...
import {
  ...
  GetConversationByIdRequest$zodSchema,
} from "../models/getconversationbyidop.js";
 ...
 */
export function conversationsGetById(
  client$: PipeshubCore,
  request: GetConversationByIdRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetConversationByIdRequest$zodSchema.parse(value$),
