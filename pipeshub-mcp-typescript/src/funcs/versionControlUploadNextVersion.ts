...
import {
  ...
  UploadNextVersionRequest$zodSchema,
} from "../models/uploadnextversionop.js";
 ...
 * </ul>
 */
export function versionControlUploadNextVersion(
  client$: PipeshubCore,
  request: UploadNextVersionRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UploadNextVersionRequest$zodSchema.parse(value$),
