...
import {
  ConnectorGetSignedUrlOpServerList,
  ConnectorGetSignedUrlRequest,
  ConnectorGetSignedUrlRequest$zodSchema,
  ConnectorGetSignedUrlSecurity,
} from "../models/connectorgetsignedurlop.js";
...
export function connectorServiceGetSignedUrl(
  client$: PipeshubCore,
  security: ConnectorGetSignedUrlSecurity,
  request: ConnectorGetSignedUrlRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ConnectorGetSignedUrlRequest$zodSchema.parse(value$),
