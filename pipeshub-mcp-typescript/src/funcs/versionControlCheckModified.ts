...
import {
  ...
  CheckDocumentModifiedRequest$zodSchema,
} from "../models/checkdocumentmodifiedop.js";
 ...
 */
export function versionControlCheckModified(
  client$: PipeshubCore,
  request: CheckDocumentModifiedRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CheckDocumentModifiedRequest$zodSchema.parse(value$),
