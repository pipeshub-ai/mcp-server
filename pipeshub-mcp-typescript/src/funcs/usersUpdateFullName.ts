...
import {
  ...
  UpdateUserFullNameRequest$zodSchema,
} from "../models/updateuserfullnameop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UpdateUserFullNameRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/users/{id}/fullname")(
    pathParams$,
  );
