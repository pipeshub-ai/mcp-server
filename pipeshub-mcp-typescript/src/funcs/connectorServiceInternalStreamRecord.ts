...
import {
  ConnectorInternalStreamRecordOpServerList,
  ConnectorInternalStreamRecordRequest,
  ConnectorInternalStreamRecordRequest$zodSchema,
  ConnectorInternalStreamRecordSecurity,
} from "../models/connectorinternalstreamrecordop.js";
...
export function connectorServiceInternalStreamRecord(
  client$: PipeshubCore,
  security: ConnectorInternalStreamRecordSecurity,
  request: ConnectorInternalStreamRecordRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ConnectorInternalStreamRecordRequest$zodSchema.parse(value$),
