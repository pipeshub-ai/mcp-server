...
Listed on Cursor Directory as https://cursor.directory/plugins/mcp-server-3
(from this repo). Do not curl first-run APIs;
...
The bootstrap script that writes the PAT to a file is
https://docs.pipeshub.com/for-agents-bootstrap.md
