...
export function buildSDK(headers, cliFlags, disableStaticAuth, logger) {
    const flags = {
        ...cliFlags,
        "bearer-auth": resolveHeader(headers, "bearerAuth", z.string(), cliFlags["bearer-auth"], disableStaticAuth),
        "client-id": resolveHeader(headers, "clientID", z.string(), cliFlags["client-id"], disableStaticAuth),
        "client-secret": resolveHeader(headers, "clientSecret", z.string(), cliFlags["client-secret"], disableStaticAuth),
        "token-url": resolveHeader(headers, "tokenURL", z.string().default("/api/v1/oauth2/token"), cliFlags["token-url"], disableStaticAuth),
    };
