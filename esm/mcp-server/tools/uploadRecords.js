 ...
 */
import { uploadRecords } from "../../funcs/uploadRecords.js";
...
export const tool$uploadRecords = {
    name: "upload-records",
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await uploadRecords(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=uploadRecords.js.map