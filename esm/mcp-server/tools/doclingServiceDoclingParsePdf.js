 ...
 */
import { doclingServiceDoclingParsePdf } from "../../funcs/doclingServiceDoclingParsePdf.js";
...
export const tool$doclingServiceDoclingParsePdf = {
    name: "docling-service-docling-parse-pdf",
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await doclingServiceDoclingParsePdf(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=doclingServiceDoclingParsePdf.js.map