 ...
 */
import { doclingsCreateBlocks } from "../../funcs/doclingsCreateBlocks.js";
...
export const tool$doclingsCreateBlocks = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await doclingsCreateBlocks(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
