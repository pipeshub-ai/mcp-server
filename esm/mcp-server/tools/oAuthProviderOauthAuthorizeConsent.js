...
export const tool$oAuthProviderOauthAuthorizeConsent = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await oAuthProviderOauthAuthorizeConsent(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
