...
export const tool$documentManagementDeleteById = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await documentManagementDeleteById(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=documentManagementDeleteById.js.map