...
export const tool$userGroupsGetStats = {
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await userGroupsGetStats(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=userGroupsGetStats.js.map