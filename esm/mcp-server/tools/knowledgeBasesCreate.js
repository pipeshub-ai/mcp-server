 ...
 */
import { knowledgeBasesCreate } from "../../funcs/knowledgeBasesCreate.js";
...
export const tool$knowledgeBasesCreate = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await knowledgeBasesCreate(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
