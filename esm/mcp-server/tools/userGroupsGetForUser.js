 ...
 */
import { userGroupsGetForUser } from "../../funcs/userGroupsGetForUser.js";
...
export const tool$userGroupsGetForUser = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await userGroupsGetForUser(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=userGroupsGetForUser.js.map