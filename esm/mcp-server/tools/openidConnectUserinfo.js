...
export const tool$openidConnectUserinfo = {
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await openidConnectUserinfo(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=openidConnectUserinfo.js.map