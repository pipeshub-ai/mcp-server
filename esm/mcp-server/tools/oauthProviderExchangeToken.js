 ...
 */
import { oauthProviderExchangeToken } from "../../funcs/oauthProviderExchangeToken.js";
...
export const tool$oauthProviderExchangeToken = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await oauthProviderExchangeToken(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=oauthProviderExchangeToken.js.map