...
export const tool$smtpConfigurationCreateSMTPConfig = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await smtpConfigurationCreateSMTPConfig(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=smtpConfigurationCreateSMTPConfig.js.map