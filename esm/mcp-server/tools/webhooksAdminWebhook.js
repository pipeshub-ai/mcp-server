 ...
 */
import { webhooksAdminWebhook } from "../../funcs/webhooksAdminWebhook.js";
import { formatResult } from "../tools.js";
export const tool$webhooksAdminWebhook = {
    name: "webhooks-admin-webhook",
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await webhooksAdminWebhook(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
