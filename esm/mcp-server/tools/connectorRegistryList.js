 ...
 */
import { connectorRegistryList } from "../../funcs/connectorRegistryList.js";
...
export const tool$connectorRegistryList = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await connectorRegistryList(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=connectorRegistryList.js.map