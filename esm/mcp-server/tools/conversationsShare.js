...
export const tool$conversationsShare = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await conversationsShare(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=conversationsShare.js.map