 ...
 */
import { samlSignIn } from "../../funcs/samlSignIn.js";
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await samlSignIn(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=samlSignIn.js.map