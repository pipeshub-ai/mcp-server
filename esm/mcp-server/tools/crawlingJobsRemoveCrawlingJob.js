 ...
 */
import { crawlingJobsRemoveCrawlingJob } from "../../funcs/crawlingJobsRemoveCrawlingJob.js";
...
export const tool$crawlingJobsRemoveCrawlingJob = {
    name: "crawling-jobs-remove-crawling-job",
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await crawlingJobsRemoveCrawlingJob(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=crawlingJobsRemoveCrawlingJob.js.map