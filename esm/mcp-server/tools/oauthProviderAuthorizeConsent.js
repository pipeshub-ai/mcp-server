 ...
 */
import { oauthProviderAuthorizeConsent } from "../../funcs/oauthProviderAuthorizeConsent.js";
...
export const tool$oauthProviderAuthorizeConsent = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await oauthProviderAuthorizeConsent(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=oauthProviderAuthorizeConsent.js.map