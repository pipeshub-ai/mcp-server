...
export const tool$usersUploadUserDisplayPicture = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await usersUploadUserDisplayPicture(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
