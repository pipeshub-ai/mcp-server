...
export const tool$permissionsCreateKBPermission = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await permissionsCreateKBPermission(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
