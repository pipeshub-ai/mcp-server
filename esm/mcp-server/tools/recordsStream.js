 ...
 */
import { recordsStream } from "../../funcs/recordsStream.js";
...
export const tool$recordsStream = {
    name: "records-stream",
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await recordsStream(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
