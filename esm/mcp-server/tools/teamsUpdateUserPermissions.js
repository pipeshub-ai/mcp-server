...
export const tool$teamsUpdateUserPermissions = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await teamsUpdateUserPermissions(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=teamsUpdateUserPermissions.js.map