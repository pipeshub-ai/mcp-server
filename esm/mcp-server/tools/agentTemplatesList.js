...
export const tool$agentTemplatesList = {
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await agentTemplatesList(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=agentTemplatesList.js.map