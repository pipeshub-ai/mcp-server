 ...
 */
import { queryServiceQueryListTools } from "../../funcs/queryServiceQueryListTools.js";
import { formatResult } from "../tools.js";
export const tool$queryServiceQueryListTools = {
    name: "query-service-query-list-tools",
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await queryServiceQueryListTools(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=queryServiceQueryListTools.js.map