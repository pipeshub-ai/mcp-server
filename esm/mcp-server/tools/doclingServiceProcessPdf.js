 ...
 */
import { doclingServiceProcessPdf } from "../../funcs/doclingServiceProcessPdf.js";
...
export const tool$doclingServiceProcessPdf = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await doclingServiceProcessPdf(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
