 ...
 */
import { oauthAppsRegenerateSecret } from "../../funcs/oauthAppsRegenerateSecret.js";
...
export const tool$oauthAppsRegenerateSecret = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await oauthAppsRegenerateSecret(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
