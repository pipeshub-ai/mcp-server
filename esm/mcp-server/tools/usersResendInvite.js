 ...
 */
import { usersResendInvite } from "../../funcs/usersResendInvite.js";
...
export const tool$usersResendInvite = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await usersResendInvite(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=usersResendInvite.js.map