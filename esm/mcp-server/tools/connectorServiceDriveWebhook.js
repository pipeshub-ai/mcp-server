 ...
 */
import { connectorServiceDriveWebhook } from "../../funcs/connectorServiceDriveWebhook.js";
import { formatResult } from "../tools.js";
export const tool$connectorServiceDriveWebhook = {
    name: "connector-service-drive-webhook",
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await connectorServiceDriveWebhook(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=connectorServiceDriveWebhook.js.map