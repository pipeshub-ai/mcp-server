...
export const tool$organizationsGetLogo = {
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await organizationsGetLogo(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=organizationsGetLogo.js.map