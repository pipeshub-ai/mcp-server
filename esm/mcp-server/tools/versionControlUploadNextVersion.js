...
export const tool$versionControlUploadNextVersion = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await versionControlUploadNextVersion(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
