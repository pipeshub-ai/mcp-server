 ...
 */
import { recordsGetKBRecords } from "../../funcs/recordsGetKBRecords.js";
...
export const tool$recordsGetKBRecords = {
    name: "records-get-KB-records",
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await recordsGetKBRecords(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=recordsGetKBRecords.js.map