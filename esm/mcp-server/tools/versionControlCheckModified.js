...
export const tool$versionControlCheckModified = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await versionControlCheckModified(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
