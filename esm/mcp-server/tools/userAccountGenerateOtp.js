 ...
 */
import { userAccountGenerateOtp } from "../../funcs/userAccountGenerateOtp.js";
...
export const tool$userAccountGenerateOtp = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await userAccountGenerateOtp(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=userAccountGenerateOtp.js.map