 ...
 */
import { queueManagementGetQueueStats } from "../../funcs/queueManagementGetQueueStats.js";
import { formatResult } from "../tools.js";
export const tool$queueManagementGetQueueStats = {
    name: "queue-management-get-queue-stats",
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await queueManagementGetQueueStats(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=queueManagementGetQueueStats.js.map