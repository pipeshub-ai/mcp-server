...
export const tool$metricsCollectionGet = {
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await metricsCollectionGet(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=metricsCollectionGet.js.map