...
export const tool$conversationsDelete = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await conversationsDelete(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=conversationsDelete.js.map