 ...
 */
import { teamsListForUser } from "../../funcs/teamsListForUser.js";
...
export const tool$teamsListForUser = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await teamsListForUser(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
