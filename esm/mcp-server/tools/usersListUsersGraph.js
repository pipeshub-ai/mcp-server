 ...
 */
import { usersListUsersGraph } from "../../funcs/usersListUsersGraph.js";
...
export const tool$usersListUsersGraph = {
    name: "users-list-users-graph",
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await usersListUsersGraph(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=usersListUsersGraph.js.map