 ...
 */
import { conversationsCreateConversation } from "../../funcs/conversationsCreateConversation.js";
...
export const tool$conversationsCreateConversation = {
    name: "conversations-create-conversation",
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await conversationsCreateConversation(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=conversationsCreateConversation.js.map