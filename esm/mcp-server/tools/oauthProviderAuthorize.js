 ...
 */
import { oauthProviderAuthorize } from "../../funcs/oauthProviderAuthorize.js";
...
export const tool$oauthProviderAuthorize = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await oauthProviderAuthorize(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=oauthProviderAuthorize.js.map