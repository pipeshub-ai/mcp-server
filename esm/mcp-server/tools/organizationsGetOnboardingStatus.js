...
export const tool$organizationsGetOnboardingStatus = {
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await organizationsGetOnboardingStatus(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=organizationsGetOnboardingStatus.js.map