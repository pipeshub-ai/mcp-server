 ...
 */
import { oauthProviderRevoke } from "../../funcs/oauthProviderRevoke.js";
...
export const tool$oauthProviderRevoke = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await oauthProviderRevoke(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=oauthProviderRevoke.js.map