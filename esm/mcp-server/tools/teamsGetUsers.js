...
export const tool$teamsGetUsers = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await teamsGetUsers(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=teamsGetUsers.js.map