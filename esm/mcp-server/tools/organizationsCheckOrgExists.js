...
export const tool$organizationsCheckOrgExists = {
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await organizationsCheckOrgExists(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=organizationsCheckOrgExists.js.map