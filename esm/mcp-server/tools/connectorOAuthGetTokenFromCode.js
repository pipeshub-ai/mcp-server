...
export const tool$connectorOAuthGetTokenFromCode = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await connectorOAuthGetTokenFromCode(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
