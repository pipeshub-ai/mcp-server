 ...
 */
import { uploadGetLimits } from "../../funcs/uploadGetLimits.js";
import { formatResult } from "../tools.js";
export const tool$uploadGetLimits = {
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await uploadGetLimits(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=uploadGetLimits.js.map