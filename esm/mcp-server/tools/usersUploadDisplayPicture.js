 ...
 */
import { usersUploadDisplayPicture } from "../../funcs/usersUploadDisplayPicture.js";
...
export const tool$usersUploadDisplayPicture = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await usersUploadDisplayPicture(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
