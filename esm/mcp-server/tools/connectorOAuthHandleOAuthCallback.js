...
export const tool$connectorOAuthHandleOAuthCallback = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await connectorOAuthHandleOAuthCallback(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
