 ...
 */
import { recordsGetAllRecords } from "../../funcs/recordsGetAllRecords.js";
...
export const tool$recordsGetAllRecords = {
    name: "records-get-all-records",
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await recordsGetAllRecords(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=recordsGetAllRecords.js.map