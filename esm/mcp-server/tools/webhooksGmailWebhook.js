 ...
 */
import { webhooksGmailWebhook } from "../../funcs/webhooksGmailWebhook.js";
import { formatResult } from "../tools.js";
export const tool$webhooksGmailWebhook = {
    name: "webhooks-gmail-webhook",
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await webhooksGmailWebhook(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
