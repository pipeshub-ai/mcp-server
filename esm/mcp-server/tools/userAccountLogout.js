...
export const tool$userAccountLogout = {
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await userAccountLogout(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=userAccountLogout.js.map