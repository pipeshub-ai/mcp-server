 ...
 */
import { queryServiceChat } from "../../funcs/queryServiceChat.js";
...
export const tool$queryServiceChat = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await queryServiceChat(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
