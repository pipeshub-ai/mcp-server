 ...
 */
import { usersRemoveDisplayPicture } from "../../funcs/usersRemoveDisplayPicture.js";
import { formatResult } from "../tools.js";
export const tool$usersRemoveDisplayPicture = {
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await usersRemoveDisplayPicture(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
