...
export const tool$usersGetAllUsers = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await usersGetAllUsers(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=usersGetAllUsers.js.map