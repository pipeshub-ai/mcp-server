...
export const tool$organizationsGetCurrent = {
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await organizationsGetCurrent(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=organizationsGetCurrent.js.map