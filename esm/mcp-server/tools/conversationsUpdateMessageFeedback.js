...
export const tool$conversationsUpdateMessageFeedback = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await conversationsUpdateMessageFeedback(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=conversationsUpdateMessageFeedback.js.map