...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await smtpConfigurationsCreate(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=smtpConfigurationsCreate.js.map