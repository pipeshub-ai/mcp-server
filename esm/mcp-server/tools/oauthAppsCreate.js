 ...
 */
import { oauthAppsCreate } from "../../funcs/oauthAppsCreate.js";
...
export const tool$oauthAppsCreate = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await oauthAppsCreate(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=oauthAppsCreate.js.map