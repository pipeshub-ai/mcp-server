 ...
 */
import { connectorControlToggleConnector } from "../../funcs/connectorControlToggleConnector.js";
...
export const tool$connectorControlToggleConnector = {
    name: "connector-control-toggle-connector",
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await connectorControlToggleConnector(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=connectorControlToggleConnector.js.map