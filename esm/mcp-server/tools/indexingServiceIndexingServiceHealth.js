 ...
 */
import { indexingServiceIndexingServiceHealth } from "../../funcs/indexingServiceIndexingServiceHealth.js";
import { formatResult } from "../tools.js";
export const tool$indexingServiceIndexingServiceHealth = {
    name: "indexing-service-indexing-service-health",
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await indexingServiceIndexingServiceHealth(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
