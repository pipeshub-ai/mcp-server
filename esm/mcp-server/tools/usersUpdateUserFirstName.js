 ...
 */
import { usersUpdateUserFirstName } from "../../funcs/usersUpdateUserFirstName.js";
...
export const tool$usersUpdateUserFirstName = {
    name: "users-update-user-first-name",
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await usersUpdateUserFirstName(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=usersUpdateUserFirstName.js.map