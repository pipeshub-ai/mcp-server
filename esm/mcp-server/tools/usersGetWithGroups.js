 ...
 */
import { usersGetWithGroups } from "../../funcs/usersGetWithGroups.js";
...
export const tool$usersGetWithGroups = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await usersGetWithGroups(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=usersGetWithGroups.js.map