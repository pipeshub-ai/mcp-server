...
export const tool$oAuthProviderOauthAuthorize = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await oAuthProviderOauthAuthorize(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
