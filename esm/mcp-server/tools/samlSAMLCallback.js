 ...
 */
import { samlSAMLCallback } from "../../funcs/samlSAMLCallback.js";
...
export const tool$samlSAMLCallback = {
    name: "saml-saml-callback",
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await samlSAMLCallback(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=samlSAMLCallback.js.map