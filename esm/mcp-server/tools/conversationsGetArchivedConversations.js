...
export const tool$conversationsGetArchivedConversations = {
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await conversationsGetArchivedConversations(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=conversationsGetArchivedConversations.js.map