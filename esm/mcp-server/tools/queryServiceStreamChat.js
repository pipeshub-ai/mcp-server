 ...
 */
import { queryServiceStreamChat } from "../../funcs/queryServiceStreamChat.js";
import { formatResult } from "../tools.js";
export const tool$queryServiceStreamChat = {
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await queryServiceStreamChat(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
