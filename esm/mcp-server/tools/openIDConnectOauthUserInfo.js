...
export const tool$openIDConnectOauthUserInfo = {
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await openIDConnectOauthUserInfo(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=openIDConnectOauthUserInfo.js.map