 ...
 */
import { documentBufferUpdate } from "../../funcs/documentBufferUpdate.js";
...
export const tool$documentBufferUpdate = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await documentBufferUpdate(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
