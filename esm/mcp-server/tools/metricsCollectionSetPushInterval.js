 ...
 */
import { metricsCollectionSetPushInterval } from "../../funcs/metricsCollectionSetPushInterval.js";
...
export const tool$metricsCollectionSetPushInterval = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await metricsCollectionSetPushInterval(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=metricsCollectionSetPushInterval.js.map