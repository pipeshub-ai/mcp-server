 ...
 */
import { crawlingJobsSchedule } from "../../funcs/crawlingJobsSchedule.js";
...
export const tool$crawlingJobsSchedule = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await crawlingJobsSchedule(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
