...
export const tool$conversationsGetConversationById = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await conversationsGetConversationById(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=conversationsGetConversationById.js.map