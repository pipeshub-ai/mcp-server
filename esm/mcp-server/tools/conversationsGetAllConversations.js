...
export const tool$conversationsGetAllConversations = {
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await conversationsGetAllConversations(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=conversationsGetAllConversations.js.map