 ...
 */
import { oauthExchangeCode } from "../../funcs/oauthExchangeCode.js";
...
export const tool$oauthExchangeCode = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await oauthExchangeCode(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=oauthExchangeCode.js.map