 ...
 */
import { crawlingJobsGetCrawlingJobStatus } from "../../funcs/crawlingJobsGetCrawlingJobStatus.js";
...
export const tool$crawlingJobsGetCrawlingJobStatus = {
    name: "crawling-jobs-get-crawling-job-status",
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await crawlingJobsGetCrawlingJobStatus(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=crawlingJobsGetCrawlingJobStatus.js.map