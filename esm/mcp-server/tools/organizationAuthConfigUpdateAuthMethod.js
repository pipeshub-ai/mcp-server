...
export const tool$organizationAuthConfigUpdateAuthMethod = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await organizationAuthConfigUpdateAuthMethod(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
