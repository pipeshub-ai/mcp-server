 ...
 */
import { usersGetEmailById } from "../../funcs/usersGetEmailById.js";
...
export const tool$usersGetEmailById = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await usersGetEmailById(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=usersGetEmailById.js.map