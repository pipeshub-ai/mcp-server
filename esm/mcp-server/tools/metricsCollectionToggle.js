...
export const tool$metricsCollectionToggle = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await metricsCollectionToggle(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=metricsCollectionToggle.js.map