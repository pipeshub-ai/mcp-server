 ...
 */
import { conversationsRegenerateAnswer } from "../../funcs/conversationsRegenerateAnswer.js";
...
export const tool$conversationsRegenerateAnswer = {
    name: "conversations-regenerate-answer",
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await conversationsRegenerateAnswer(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
