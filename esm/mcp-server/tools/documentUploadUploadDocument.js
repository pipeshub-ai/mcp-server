 ...
 */
import { documentUploadUploadDocument } from "../../funcs/documentUploadUploadDocument.js";
...
export const tool$documentUploadUploadDocument = {
    name: "document-upload-upload-document",
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await documentUploadUploadDocument(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=documentUploadUploadDocument.js.map