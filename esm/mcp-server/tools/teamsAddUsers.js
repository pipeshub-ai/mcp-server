 ...
 */
import { teamsAddUsers } from "../../funcs/teamsAddUsers.js";
...
export const tool$teamsAddUsers = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await teamsAddUsers(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
