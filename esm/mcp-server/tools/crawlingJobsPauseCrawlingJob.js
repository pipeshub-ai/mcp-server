...
export const tool$crawlingJobsPauseCrawlingJob = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await crawlingJobsPauseCrawlingJob(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
