 ...
 */
import { organizationsCheckExists } from "../../funcs/organizationsCheckExists.js";
import { formatResult } from "../tools.js";
export const tool$organizationsCheckExists = {
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await organizationsCheckExists(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
