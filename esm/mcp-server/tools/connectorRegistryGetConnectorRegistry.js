...
export const tool$connectorRegistryGetConnectorRegistry = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await connectorRegistryGetConnectorRegistry(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=connectorRegistryGetConnectorRegistry.js.map