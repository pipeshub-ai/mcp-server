...
export const tool$samlCallback = {
    name: "saml-callback",
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await samlCallback(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=samlCallback.js.map