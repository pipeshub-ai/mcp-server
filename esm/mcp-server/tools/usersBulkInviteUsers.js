 ...
 */
import { usersBulkInviteUsers } from "../../funcs/usersBulkInviteUsers.js";
...
export const tool$usersBulkInviteUsers = {
    name: "users-bulk-invite-users",
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await usersBulkInviteUsers(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=usersBulkInviteUsers.js.map