 ...
 */
import { crawlingJobsScheduleCrawlingJob } from "../../funcs/crawlingJobsScheduleCrawlingJob.js";
import { ScheduleCrawlingJobRequest$zodSchema } from "../../models/schedulecrawlingjobop.js";
import { formatResult } from "../tools.js";
const args = {
    request: ScheduleCrawlingJobRequest$zodSchema,
};
export const tool$crawlingJobsScheduleCrawlingJob = {
    name: "crawling-jobs-schedule-crawling-job",
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await crawlingJobsScheduleCrawlingJob(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=crawlingJobsScheduleCrawlingJob.js.map