...
export const tool$userAccountGenerateLoginOtp = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await userAccountGenerateLoginOtp(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
