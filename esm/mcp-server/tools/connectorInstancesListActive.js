...
export const tool$connectorInstancesListActive = {
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await connectorInstancesListActive(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=connectorInstancesListActive.js.map