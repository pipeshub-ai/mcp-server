 ...
 */
import { agentsListTools } from "../../funcs/agentsListTools.js";
import { formatResult } from "../tools.js";
export const tool$agentsListTools = {
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await agentsListTools(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=agentsListTools.js.map