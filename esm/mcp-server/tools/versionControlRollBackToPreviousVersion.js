 ...
 */
import { versionControlRollBackToPreviousVersion } from "../../funcs/versionControlRollBackToPreviousVersion.js";
...
export const tool$versionControlRollBackToPreviousVersion = {
    name: "version-control-roll-back-to-previous-version",
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await versionControlRollBackToPreviousVersion(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=versionControlRollBackToPreviousVersion.js.map