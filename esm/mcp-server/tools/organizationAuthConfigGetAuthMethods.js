...
export const tool$organizationAuthConfigGetAuthMethods = {
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await organizationAuthConfigGetAuthMethods(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=organizationAuthConfigGetAuthMethods.js.map