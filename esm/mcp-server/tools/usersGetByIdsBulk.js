 ...
 */
import { usersGetByIdsBulk } from "../../funcs/usersGetByIdsBulk.js";
...
export const tool$usersGetByIdsBulk = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await usersGetByIdsBulk(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=usersGetByIdsBulk.js.map