 ...
 */
import { connectorOAuthGetAuthorizationUrl } from "../../funcs/connectorOAuthGetAuthorizationUrl.js";
...
export const tool$connectorOAuthGetAuthorizationUrl = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await connectorOAuthGetAuthorizationUrl(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=connectorOAuthGetAuthorizationUrl.js.map