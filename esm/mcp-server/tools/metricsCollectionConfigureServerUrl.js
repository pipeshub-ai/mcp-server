 ...
 */
import { metricsCollectionConfigureServerUrl } from "../../funcs/metricsCollectionConfigureServerUrl.js";
...
export const tool$metricsCollectionConfigureServerUrl = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await metricsCollectionConfigureServerUrl(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=metricsCollectionConfigureServerUrl.js.map