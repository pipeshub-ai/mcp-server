 ...
 */
import { documentManagementDownloadDocument } from "../../funcs/documentManagementDownloadDocument.js";
...
export const tool$documentManagementDownloadDocument = {
    name: "document-management-download-document",
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await documentManagementDownloadDocument(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
