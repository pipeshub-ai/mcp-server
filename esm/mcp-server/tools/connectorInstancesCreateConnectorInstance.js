 ...
 */
import { connectorInstancesCreateConnectorInstance } from "../../funcs/connectorInstancesCreateConnectorInstance.js";
...
export const tool$connectorInstancesCreateConnectorInstance = {
    name: "connector-instances-create-connector-instance",
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await connectorInstancesCreateConnectorInstance(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=connectorInstancesCreateConnectorInstance.js.map