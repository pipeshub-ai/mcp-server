 ...
 */
import { documentBufferGetDocumentBuffer } from "../../funcs/documentBufferGetDocumentBuffer.js";
...
export const tool$documentBufferGetDocumentBuffer = {
    name: "document-buffer-get-document-buffer",
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await documentBufferGetDocumentBuffer(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
