...
export const tool$crawlingJobsRemoveAll = {
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await crawlingJobsRemoveAll(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=crawlingJobsRemoveAll.js.map