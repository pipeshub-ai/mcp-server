 ...
 */
import { usersGetDisplayPicture } from "../../funcs/usersGetDisplayPicture.js";
import { formatResult } from "../tools.js";
export const tool$usersGetDisplayPicture = {
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await usersGetDisplayPicture(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
