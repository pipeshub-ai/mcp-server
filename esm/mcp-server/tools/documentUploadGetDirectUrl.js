 ...
 */
import { documentUploadGetDirectUrl } from "../../funcs/documentUploadGetDirectUrl.js";
...
export const tool$documentUploadGetDirectUrl = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await documentUploadGetDirectUrl(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=documentUploadGetDirectUrl.js.map