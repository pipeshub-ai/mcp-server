...
export const tool$organizationsCreateOrganization = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await organizationsCreateOrganization(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
