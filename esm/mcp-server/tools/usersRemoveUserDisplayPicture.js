...
export const tool$usersRemoveUserDisplayPicture = {
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await usersRemoveUserDisplayPicture(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=usersRemoveUserDisplayPicture.js.map