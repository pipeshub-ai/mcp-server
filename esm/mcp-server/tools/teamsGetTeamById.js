 ...
 */
import { teamsGetTeamById } from "../../funcs/teamsGetTeamById.js";
...
export const tool$teamsGetTeamById = {
    name: "teams-get-team-by-id",
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await teamsGetTeamById(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=teamsGetTeamById.js.map