 ...
 */
import { documentUploadCreatePlaceholder } from "../../funcs/documentUploadCreatePlaceholder.js";
...
export const tool$documentUploadCreatePlaceholder = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await documentUploadCreatePlaceholder(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
