...
export const tool$usersDeleteUser = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await usersDeleteUser(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=usersDeleteUser.js.map