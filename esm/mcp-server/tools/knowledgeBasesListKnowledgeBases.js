 ...
 */
import { knowledgeBasesListKnowledgeBases } from "../../funcs/knowledgeBasesListKnowledgeBases.js";
...
export const tool$knowledgeBasesListKnowledgeBases = {
    name: "knowledge-bases-list-knowledge-bases",
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await knowledgeBasesListKnowledgeBases(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=knowledgeBasesListKnowledgeBases.js.map