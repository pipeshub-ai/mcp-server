...
export const tool$crawlingJobsGetAllCrawlingJobStatus = {
...
`,
    ...
    tool: async (client, ctx) => {
        const [result] = await crawlingJobsGetAllCrawlingJobStatus(client, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
