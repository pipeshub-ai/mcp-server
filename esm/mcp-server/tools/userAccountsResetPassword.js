...
export const tool$userAccountsResetPassword = {
...
`,
    ...
    tool: async (client, args, ctx) => {
        const [result] = await userAccountsResetPassword(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
...
//# sourceMappingURL=userAccountsResetPassword.js.map