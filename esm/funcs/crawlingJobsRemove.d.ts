 ...
 * </ul>
 */
export declare function crawlingJobsRemove(client$: PipeshubCore, request: RemoveCrawlingJobRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=crawlingJobsRemove.d.ts.map