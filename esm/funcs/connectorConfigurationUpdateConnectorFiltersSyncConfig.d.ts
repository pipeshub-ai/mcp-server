 ...
 */
export declare function connectorConfigurationUpdateConnectorFiltersSyncConfig(client$: PipeshubCore, request: UpdateConnectorFiltersSyncConfigRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=connectorConfigurationUpdateConnectorFiltersSyncConfig.d.ts.map