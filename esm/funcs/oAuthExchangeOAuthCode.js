 ...
 */
export function oAuthExchangeOAuthCode(client$, request, options) {
    return new APIPromise($do(client$, request, options));
}
async function $do(client$, request, options) {
    const parsed$ = safeParse(request, (value$) => OAuthExchangeRequest$zodSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
...
//# sourceMappingURL=oAuthExchangeOAuthCode.js.map