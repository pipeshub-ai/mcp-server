 ...
 */
export declare function oAuthConfigurationCreateOAuthConfig(client$: PipeshubCore, request: CreateOAuthConfigRequestRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=oAuthConfigurationCreateOAuthConfig.d.ts.map