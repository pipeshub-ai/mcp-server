 ...
 */
export declare function connectorServiceConnectorGetSignedUrl(client$: PipeshubCore, security: ConnectorGetSignedUrlSecurity, request: ConnectorGetSignedUrlRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=connectorServiceConnectorGetSignedUrl.d.ts.map