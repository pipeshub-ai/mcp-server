...
import { CheckUserExistsByEmailRequest$zodSchema, } from "../models/checkuserexistsbyemailop.js";
 ...
 */
export function usersCheckUserExistsByEmail(client$, security, request, options) {
    return new APIPromise($do(client$, security, request, options));
}
async function $do(client$, security, request, options) {
    const parsed$ = safeParse(request, (value$) => CheckUserExistsByEmailRequest$zodSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
...
//# sourceMappingURL=usersCheckUserExistsByEmail.js.map