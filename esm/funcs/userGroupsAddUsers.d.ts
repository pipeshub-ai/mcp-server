 ...
 * </ul>
 */
export declare function userGroupsAddUsers(client$: PipeshubCore, request: AddUsersToGroupRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=userGroupsAddUsers.d.ts.map