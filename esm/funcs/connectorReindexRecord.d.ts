 ...
 */
export declare function connectorReindexRecord(client$: PipeshubCore, request: ReindexRecordRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=connectorReindexRecord.d.ts.map