 ...
 */
export declare function usersGetInternalUser(client$: PipeshubCore, security: GetInternalUserSecurity, request: GetInternalUserRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=usersGetInternalUser.d.ts.map