 ...
 */
export function oauthProviderExchangeToken(client$, request, options) {
    return new APIPromise($do(client$, request, options));
}
async function $do(client$, request, options) {
    const parsed$ = safeParse(request, (value$) => OAuthTokenRequest$zodSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
