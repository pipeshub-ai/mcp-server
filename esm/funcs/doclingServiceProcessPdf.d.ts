 ...
 */
export declare function doclingServiceProcessPdf(client$: PipeshubCore, request: DoclingProcessPdfRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=doclingServiceProcessPdf.d.ts.map