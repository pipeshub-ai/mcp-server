 ...
 */
export declare function connectorServiceReindexFailedRecords(client$: PipeshubCore, security: ConnectorReindexFailedRecordsSecurity, request: ConnectorReindexFailedRecordsRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=connectorServiceReindexFailedRecords.d.ts.map