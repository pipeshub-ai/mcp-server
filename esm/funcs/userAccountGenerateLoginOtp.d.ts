 ...
 */
export declare function userAccountGenerateLoginOtp(client$: PipeshubCore, request: OtpGenerateRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=userAccountGenerateLoginOtp.d.ts.map