 ...
 */
export declare function connectorOAuthGetOAuthAuthorizationUrl(client$: PipeshubCore, request: GetOAuthAuthorizationUrlRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=connectorOAuthGetOAuthAuthorizationUrl.d.ts.map