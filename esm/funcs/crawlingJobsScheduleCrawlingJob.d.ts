 ...
 * </ul>
 */
export declare function crawlingJobsScheduleCrawlingJob(client$: PipeshubCore, request: ScheduleCrawlingJobRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=crawlingJobsScheduleCrawlingJob.d.ts.map