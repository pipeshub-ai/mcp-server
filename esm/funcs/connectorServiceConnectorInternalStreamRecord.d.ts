 ...
 */
export declare function connectorServiceConnectorInternalStreamRecord(client$: PipeshubCore, security: ConnectorInternalStreamRecordSecurity, request: ConnectorInternalStreamRecordRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=connectorServiceConnectorInternalStreamRecord.d.ts.map