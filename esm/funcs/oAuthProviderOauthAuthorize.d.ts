 ...
 */
export declare function oAuthProviderOauthAuthorize(client$: PipeshubCore, request: OauthAuthorizeRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=oAuthProviderOauthAuthorize.d.ts.map