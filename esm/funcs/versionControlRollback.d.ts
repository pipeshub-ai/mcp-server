 ...
 * </ul>
 */
export declare function versionControlRollback(client$: PipeshubCore, request: RollBackToPreviousVersionRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=versionControlRollback.d.ts.map