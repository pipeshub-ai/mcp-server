 ...
 */
export function organizationAuthConfigUpdateAuthMethod(client$, request, options) {
    return new APIPromise($do(client$, request, options));
}
async function $do(client$, request, options) {
    const parsed$ = safeParse(request, (value$) => AuthConfig$zodSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
...
//# sourceMappingURL=organizationAuthConfigUpdateAuthMethod.js.map