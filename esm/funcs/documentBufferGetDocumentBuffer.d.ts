 ...
 */
export declare function documentBufferGetDocumentBuffer(client$: PipeshubCore, request: GetDocumentBufferRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=documentBufferGetDocumentBuffer.d.ts.map