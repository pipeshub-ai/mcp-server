 ...
 */
export declare function conversationsUpdateFeedback(client$: PipeshubCore, request: UpdateMessageFeedbackRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
