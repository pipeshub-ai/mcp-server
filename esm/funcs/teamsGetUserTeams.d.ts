 ...
 * </ul>
 */
export declare function teamsGetUserTeams(client$: PipeshubCore, request?: GetUserTeamsRequest | undefined, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=teamsGetUserTeams.d.ts.map