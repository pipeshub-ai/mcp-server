 ...
 */
export declare function connectorOAuthHandleOAuthCallback(client$: PipeshubCore, request?: HandleOAuthCallbackRequest | undefined, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=connectorOAuthHandleOAuthCallback.d.ts.map