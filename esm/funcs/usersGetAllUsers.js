 ...
 * </ul>
 */
export function usersGetAllUsers(client$, request, options) {
    return new APIPromise($do(client$, request, options));
}
async function $do(client$, request, options) {
    const parsed$ = safeParse(request, (value$) => GetAllUsersRequest$zodSchema.optional().parse(value$), "Input validation failed");
    if (!parsed$.ok) {
