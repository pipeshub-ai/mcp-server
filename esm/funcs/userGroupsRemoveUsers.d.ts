 ...
 * </ul>
 */
export declare function userGroupsRemoveUsers(client$: PipeshubCore, request: RemoveUsersFromGroupRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=userGroupsRemoveUsers.d.ts.map