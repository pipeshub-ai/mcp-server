 ...
 * </ul>
 */
export declare function teamsAddUsers(client$: PipeshubCore, request: AddUsersToTeamRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=teamsAddUsers.d.ts.map