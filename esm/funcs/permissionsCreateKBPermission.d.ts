 ...
 */
export declare function permissionsCreateKBPermission(client$: PipeshubCore, request: CreateKBPermissionRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=permissionsCreateKBPermission.d.ts.map