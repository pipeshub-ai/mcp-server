 ...
 */
export declare function oAuthAppsRegenerateOAuthAppSecret(client$: PipeshubCore, request: RegenerateOAuthAppSecretRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=oAuthAppsRegenerateOAuthAppSecret.d.ts.map