 ...
 */
export declare function connectorServiceConnectorConvertRecordBuffer(client$: PipeshubCore, security: ConnectorConvertRecordBufferSecurity, request: ConnectorConvertRecordBufferRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=connectorServiceConnectorConvertRecordBuffer.d.ts.map