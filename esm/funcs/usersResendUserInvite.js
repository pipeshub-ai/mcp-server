 ...
 * </ul>
 */
export function usersResendUserInvite(client$, request, options) {
    return new APIPromise($do(client$, request, options));
}
async function $do(client$, request, options) {
    const parsed$ = safeParse(request, (value$) => ResendUserInviteRequest$zodSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
...
//# sourceMappingURL=usersResendUserInvite.js.map