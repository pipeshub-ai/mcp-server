 ...
 */
export declare function foldersGetFolderContents(client$: PipeshubCore, request: GetFolderContentsRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=foldersGetFolderContents.d.ts.map