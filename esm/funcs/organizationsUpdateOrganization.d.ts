 ...
 * </ul>
 */
export declare function organizationsUpdateOrganization(client$: PipeshubCore, request: UpdateOrganizationRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=organizationsUpdateOrganization.d.ts.map