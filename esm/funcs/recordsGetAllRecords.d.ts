 ...
 * </ul>
 */
export declare function recordsGetAllRecords(client$: PipeshubCore, request?: GetAllRecordsRequest | undefined, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=recordsGetAllRecords.d.ts.map