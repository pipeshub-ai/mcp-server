 ...
 * </ul>
 */
export declare function usersCheckIsAdmin(client$: PipeshubCore, request: CheckUserIsAdminRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=usersCheckIsAdmin.d.ts.map