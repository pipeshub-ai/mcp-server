 ...
 */
export declare function usersUpdateUserLastName(client$: PipeshubCore, request: UpdateUserLastNameRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=usersUpdateUserLastName.d.ts.map