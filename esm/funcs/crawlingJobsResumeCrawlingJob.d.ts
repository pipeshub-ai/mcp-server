 ...
 */
export declare function crawlingJobsResumeCrawlingJob(client$: PipeshubCore, request: ResumeCrawlingJobRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
