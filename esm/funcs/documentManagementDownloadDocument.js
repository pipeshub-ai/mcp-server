...
export var DownloadDocumentAcceptEnum;
(function (DownloadDocumentAcceptEnum) {
    DownloadDocumentAcceptEnum["applicationJsonAccept"] = "application/json";
    DownloadDocumentAcceptEnum["applicationOctetStreamAccept"] = "application/octet-stream";
})(DownloadDocumentAcceptEnum || (DownloadDocumentAcceptEnum = {}));
/**
 * Download document
 *
 * @remarks
 ...
 */
export function documentManagementDownloadDocument(client$, request, options) {
...
//# sourceMappingURL=documentManagementDownloadDocument.js.map