 ...
 * </ul>
 */
export function connectorControlToggleConnector(client$, request, options) {
    return new APIPromise($do(client$, request, options));
}
async function $do(client$, request, options) {
    const parsed$ = safeParse(request, (value$) => ToggleConnectorRequest$zodSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
    ...
    const path$ = pathToFunc("/connectors/{connectorId}/toggle")(pathParams$);
