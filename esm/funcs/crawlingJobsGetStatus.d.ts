 ...
 */
export declare function crawlingJobsGetStatus(client$: PipeshubCore, request: GetCrawlingJobStatusRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=crawlingJobsGetStatus.d.ts.map