...
import { GetUsersByIdsRequest } from "../models/getusersbyidsop.js";
 ...
 */
export declare function usersGetUsersByIds(client$: PipeshubCore, request: GetUsersByIdsRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=usersGetUsersByIds.d.ts.map