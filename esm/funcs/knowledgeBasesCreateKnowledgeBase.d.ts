 ...
 */
export declare function knowledgeBasesCreateKnowledgeBase(client$: PipeshubCore, request: CreateKnowledgeBaseRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=knowledgeBasesCreateKnowledgeBase.d.ts.map