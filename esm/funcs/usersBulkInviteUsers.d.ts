 ...
 */
export declare function usersBulkInviteUsers(client$: PipeshubCore, request: BulkInviteUsersRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=usersBulkInviteUsers.d.ts.map