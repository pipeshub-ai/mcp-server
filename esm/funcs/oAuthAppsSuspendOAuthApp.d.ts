 ...
 */
export declare function oAuthAppsSuspendOAuthApp(client$: PipeshubCore, request: SuspendOAuthAppRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=oAuthAppsSuspendOAuthApp.d.ts.map