 ...
 */
export declare function documentManagementDeleteDocumentById(client$: PipeshubCore, request: DeleteDocumentByIdRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=documentManagementDeleteDocumentById.d.ts.map