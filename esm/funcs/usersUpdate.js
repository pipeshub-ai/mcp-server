 ...
 * </ul>
 */
export function usersUpdate(client$, request, options) {
    return new APIPromise($do(client$, request, options));
}
async function $do(client$, request, options) {
    const parsed$ = safeParse(request, (value$) => UpdateUserRequest$zodSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
