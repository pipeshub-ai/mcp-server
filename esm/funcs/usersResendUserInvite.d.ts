 ...
 * </ul>
 */
export declare function usersResendUserInvite(client$: PipeshubCore, request: ResendUserInviteRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=usersResendUserInvite.d.ts.map