 ...
 */
export declare function documentUploadGetDirectUrl(client$: PipeshubCore, request: GetDirectUploadUrlRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=documentUploadGetDirectUrl.d.ts.map