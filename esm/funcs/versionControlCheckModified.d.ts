 ...
 */
export declare function versionControlCheckModified(client$: PipeshubCore, request: CheckDocumentModifiedRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=versionControlCheckModified.d.ts.map