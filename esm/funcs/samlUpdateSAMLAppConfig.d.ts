 ...
 */
export declare function samlUpdateSAMLAppConfig(client$: PipeshubCore, security: UpdateSamlAppConfigSecurity, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=samlUpdateSAMLAppConfig.d.ts.map