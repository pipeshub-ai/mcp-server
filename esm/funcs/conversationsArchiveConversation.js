 ...
 */
export function conversationsArchiveConversation(client$, request, options) {
    return new APIPromise($do(client$, request, options));
}
async function $do(client$, request, options) {
    const parsed$ = safeParse(request, (value$) => ArchiveConversationRequest$zodSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
    ...
    const path$ = pathToFunc("/conversations/{conversationId}/archive")(pathParams$);
