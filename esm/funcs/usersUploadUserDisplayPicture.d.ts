 ...
 */
export declare function usersUploadUserDisplayPicture(client$: PipeshubCore, request: UploadUserDisplayPictureRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=usersUploadUserDisplayPicture.d.ts.map