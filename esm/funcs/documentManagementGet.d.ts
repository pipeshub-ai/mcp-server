 ...
 */
export declare function documentManagementGet(client$: PipeshubCore, request: GetDocumentByIdRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=documentManagementGet.d.ts.map