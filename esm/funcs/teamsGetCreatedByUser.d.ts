 ...
 * </ul>
 */
export declare function teamsGetCreatedByUser(client$: PipeshubCore, request?: GetUserCreatedTeamsRequest | undefined, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=teamsGetCreatedByUser.d.ts.map