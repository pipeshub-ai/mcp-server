 ...
 */
export declare function knowledgeBasesDeleteKnowledgeBase(client$: PipeshubCore, request: DeleteKnowledgeBaseRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=knowledgeBasesDeleteKnowledgeBase.d.ts.map