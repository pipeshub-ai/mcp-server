 ...
 */
export declare function userAccountRefreshToken(client$: PipeshubCore, security: RefreshTokenSecurity, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=userAccountRefreshToken.d.ts.map