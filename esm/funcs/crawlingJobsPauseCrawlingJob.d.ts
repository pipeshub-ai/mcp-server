 ...
 */
export declare function crawlingJobsPauseCrawlingJob(client$: PipeshubCore, request: PauseCrawlingJobRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=crawlingJobsPauseCrawlingJob.d.ts.map