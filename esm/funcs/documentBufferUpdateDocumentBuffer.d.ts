 ...
 * </ul>
 */
export declare function documentBufferUpdateDocumentBuffer(client$: PipeshubCore, request: UpdateDocumentBufferRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=documentBufferUpdateDocumentBuffer.d.ts.map