 ...
 */
export declare function connectorFiltersGetConnectorFilters(client$: PipeshubCore, request: GetConnectorFiltersRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=connectorFiltersGetConnectorFilters.d.ts.map