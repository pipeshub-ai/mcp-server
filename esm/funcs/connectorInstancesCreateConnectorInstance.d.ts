 ...
 * </ol>
 */
export declare function connectorInstancesCreateConnectorInstance(client$: PipeshubCore, request: CreateConnectorRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
