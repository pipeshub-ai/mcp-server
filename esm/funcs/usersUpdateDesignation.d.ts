 ...
 */
export declare function usersUpdateDesignation(client$: PipeshubCore, request: UpdateUserDesignationRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=usersUpdateDesignation.d.ts.map