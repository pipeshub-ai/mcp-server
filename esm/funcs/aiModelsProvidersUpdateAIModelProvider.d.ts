 ...
 */
export declare function aiModelsProvidersUpdateAIModelProvider(client$: PipeshubCore, request: UpdateAIModelProviderRequestRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=aiModelsProvidersUpdateAIModelProvider.d.ts.map