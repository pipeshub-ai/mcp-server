 ...
 */
export declare function oauthProviderIntrospect(client$: PipeshubCore, request: OAuthIntrospectRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
