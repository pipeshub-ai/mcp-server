 ...
 */
export declare function oauthProviderRevoke(client$: PipeshubCore, request: OAuthRevokeRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=oauthProviderRevoke.d.ts.map