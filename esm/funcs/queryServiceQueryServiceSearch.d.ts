 ...
 * </ol>
 */
export declare function queryServiceQueryServiceSearch(client$: PipeshubCore, request: QueryServiceSearchRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=queryServiceQueryServiceSearch.d.ts.map