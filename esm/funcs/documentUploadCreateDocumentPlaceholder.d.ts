 ...
 */
export declare function documentUploadCreateDocumentPlaceholder(client$: PipeshubCore, request: CreateDocumentPlaceholderRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
