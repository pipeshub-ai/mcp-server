 ...
 */
export declare function doclingServiceParsePdf(client$: PipeshubCore, request: DoclingParsePdfRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=doclingServiceParsePdf.d.ts.map