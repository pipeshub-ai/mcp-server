...
export declare enum DownloadDocumentAcceptEnum {
 ...
 */
export declare function documentManagementDownloadDocument(client$: PipeshubCore, request: DownloadDocumentRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=documentManagementDownloadDocument.d.ts.map