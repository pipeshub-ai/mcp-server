 ...
 * </ul>
 */
export declare function queryServiceChat(client$: PipeshubCore, request: QueryServiceChatRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=queryServiceChat.d.ts.map