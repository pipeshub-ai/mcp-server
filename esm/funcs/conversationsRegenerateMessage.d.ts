 ...
 */
export declare function conversationsRegenerateMessage(client$: PipeshubCore, request: RegenerateAnswerRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=conversationsRegenerateMessage.d.ts.map