 ...
 */
export declare function recordsGetKBRecords(client$: PipeshubCore, request: GetKBRecordsRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=recordsGetKBRecords.d.ts.map