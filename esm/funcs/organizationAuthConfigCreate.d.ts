 ...
 */
export declare function organizationAuthConfigCreate(client$: PipeshubCore, request: OrgAuthConfigCreateRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=organizationAuthConfigCreate.d.ts.map