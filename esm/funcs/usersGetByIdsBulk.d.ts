 ...
 */
export declare function usersGetByIdsBulk(client$: PipeshubCore, request: GetUsersByIdsRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=usersGetByIdsBulk.d.ts.map