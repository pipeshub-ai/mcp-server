...
export declare enum GetUserDisplayPictureAcceptEnum {
 ...
 */
export declare function usersGetUserDisplayPicture(client$: PipeshubCore, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=usersGetUserDisplayPicture.d.ts.map