 ...
 * </ul>
 */
export declare function userGroupsGetGroupsForUser(client$: PipeshubCore, request: GetGroupsForUserRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=userGroupsGetGroupsForUser.d.ts.map