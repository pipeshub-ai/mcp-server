 ...
 * </ul>
 */
export declare function connectorRegistryGetSchema(client$: PipeshubCore, request: GetConnectorSchemaRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=connectorRegistryGetSchema.d.ts.map