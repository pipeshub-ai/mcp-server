 ...
 * </ul>
 */
export declare function organizationsCreate(client$: PipeshubCore, request: CreateOrganizationRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
