 ...
 */
export declare function metricsCollectionConfigureServerUrl(client$: PipeshubCore, request: SetMetricsServerUrlRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=metricsCollectionConfigureServerUrl.d.ts.map