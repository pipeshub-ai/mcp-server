 ...
 * </ul>
 */
export declare function usersGetAllUsers(client$: PipeshubCore, request?: GetAllUsersRequest | undefined, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=usersGetAllUsers.d.ts.map