 ...
 * </ul>
 */
export declare function teamsDeleteTeam(client$: PipeshubCore, request: DeleteTeamRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
