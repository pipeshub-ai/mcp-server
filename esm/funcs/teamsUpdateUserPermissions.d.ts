 ...
 * </ul>
 */
export declare function teamsUpdateUserPermissions(client$: PipeshubCore, request: UpdateTeamUserPermissionsRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=teamsUpdateUserPermissions.d.ts.map