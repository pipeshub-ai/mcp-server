 ...
 */
export declare function metricsCollectionToggle(client$: PipeshubCore, request: ToggleMetricsCollectionRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=metricsCollectionToggle.d.ts.map