 ...
 */
export declare function connectorServiceGetStats(client$: PipeshubCore, security: ConnectorGetStatsSecurity, request: ConnectorGetStatsRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=connectorServiceGetStats.d.ts.map