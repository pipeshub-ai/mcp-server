 ...
 * </ul>
 */
export declare function mailConfigurationUpdateSmtpConfig(client$: PipeshubCore, security: UpdateSmtpConfigSecurity, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=mailConfigurationUpdateSmtpConfig.d.ts.map