 ...
 * </ul>
 */
export declare function agentTemplatesCreateAgentTemplate(client$: PipeshubCore, request: CreateAgentTemplateRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=agentTemplatesCreateAgentTemplate.d.ts.map