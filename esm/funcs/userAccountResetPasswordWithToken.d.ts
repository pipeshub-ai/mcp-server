 ...
 */
export declare function userAccountResetPasswordWithToken(client$: PipeshubCore, security: ResetPasswordWithTokenSecurity, request: TokenPasswordResetRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=userAccountResetPasswordWithToken.d.ts.map