 ...
 * </ul>
 */
export declare function teamsUpdate(client$: PipeshubCore, request: UpdateTeamRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=teamsUpdate.d.ts.map