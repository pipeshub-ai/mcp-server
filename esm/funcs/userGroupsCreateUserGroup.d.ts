 ...
 * </ul>
 */
export declare function userGroupsCreateUserGroup(client$: PipeshubCore, request: CreateUserGroupRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=userGroupsCreateUserGroup.d.ts.map