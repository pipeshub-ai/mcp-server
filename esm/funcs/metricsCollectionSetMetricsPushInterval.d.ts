 ...
 */
export declare function metricsCollectionSetMetricsPushInterval(client$: PipeshubCore, request: SetMetricsPushIntervalRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=metricsCollectionSetMetricsPushInterval.d.ts.map