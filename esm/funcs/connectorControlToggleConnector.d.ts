 ...
 * </ul>
 */
export declare function connectorControlToggleConnector(client$: PipeshubCore, request: ToggleConnectorRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=connectorControlToggleConnector.d.ts.map