 ...
 * </ul>
 */
export declare function recordsUpdate(client$: PipeshubCore, request: UpdateRecordRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=recordsUpdate.d.ts.map