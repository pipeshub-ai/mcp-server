 ...
 * </ul>
 */
export declare function teamsRemoveUsers(client$: PipeshubCore, request: RemoveUsersFromTeamRequest, options?: RequestOptions): APIPromise<Result<Response, APIError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=teamsRemoveUsers.d.ts.map