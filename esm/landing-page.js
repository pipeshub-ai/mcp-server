...
export function landingPage(req) {
...
url = "${o}/sse"
http_headers = { "server-index" = "YOUR_SERVER_INDEX", "instance-url" = "YOUR_INSTANCE_URL", "bearer-auth" = "YOUR_BEARER_AUTH", "client-id" = "YOUR_CLIENT_ID", "client-secret" = "YOUR_CLIENT_SECRET", "token-url" = "YOUR_TOKEN_URL" }`;
    return `
<!DOCTYPE html>
<html lang="en">
<head>
      ...
      <div class="content-container">
            ...
            <div class="header-actions">
              ...
              <div class="popover">
                ...
                <div class="popover-menu hidden" id="popover-menu">
                  <a class="popover-button install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=SDK&config=">
                    Cursor
                  </a>
        ...
        <section class="install container">
          ...
          <div class="install-targets">
            <a tabindex="0" class="card install-target install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=SDK&config=">
              <div class="target">
        ...
        const toolBadges = visibleTools
            .map((tool) => `<span class="badge">${tool.name}</span>`)
            .join("\n");
        ...
        <section class="raw-configuration container">
          ...
          <div class="code-container card">
            ...
            <code class="code-snippet language-json" id="raw-config">${JSON.stringify(mcpConfig, null, 2)}</code>
          </div>
        </section>
      </div>
    </main>
    ...
    <div class="modal" id="claude-code-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="claude-cli-cmd">claude mcp add SDK -- npx -y mcp start --server-index 0 --instance-url https://app.pipeshub.com --bearer-auth  --client-id  --client-secret  --token-url /api/v1/oauth2/token</code>
        </div>
      </div>
    </div>
    ...
    <div class="modal" id="gemini-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="gemini-config">gemini mcp add SDK -- npx -y mcp start --server-index 0 --instance-url https://app.pipeshub.com --bearer-auth  --client-id  --client-secret  --token-url /api/v1/oauth2/token</code>
        </div>
      </div>
    </div>
